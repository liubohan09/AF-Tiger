...
class GFLSmallHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(GFLSmallHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def _init_layers(self):
        ...
        for _ in self.anchor_generator.strides:
            ...
            conv_cls = nn.Conv2d(self.feat_channels, self.cls_out_channels + 4 * (
                        self.reg_max + 1) if self.share_cls_reg else self.cls_out_channels, 1)
